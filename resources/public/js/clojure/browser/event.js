...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj14689 = {};return obj14689;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__3614__auto__ = this$;if(and__3614__auto__)
...
{var x__4262__auto__ = (((this$ == null))?null:this$);return (function (){var or__3626__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__4262__auto__)]);if(or__3626__auto__)
{return or__3626__auto__;
} else
{var or__3626__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__3626__auto____$1)
...
return (function (p__14690){var vec__14691 = p__14690;var k = cljs.core.nth.call(null,vec__14691,(0),null);var v = cljs.core.nth.call(null,vec__14691,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__14692){var vec__14693 = p__14692;var k = cljs.core.nth.call(null,vec__14693,(0),null);var v = cljs.core.nth.call(null,vec__14693,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
} else
