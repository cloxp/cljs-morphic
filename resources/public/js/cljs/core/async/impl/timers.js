...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_14169 = (0);while(true){
...
{var i_14176 = (self__.level + (1));while(true){
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_14178 = (0);while(true){
if((i_14178 <= self__.level))
{var links_14179 = (update[i_14178]).forward;if(((links_14179[i_14178]) === x__$1))
